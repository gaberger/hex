...
import { MCPAdapter, HEX_TOOLS, HEX_DASHBOARD_TOOLS, HEX_PARITY_TOOLS, HEX_HEXFLO_TOOLS } from '../../src/adapters/primary/mcp-adapter.js';
...
describe('MCPAdapter', () => {
  ...
  it('returns all analysis + dashboard tools from getTools()', () => {
    ...
    const expectedCount = HEX_TOOLS.length + HEX_DASHBOARD_TOOLS.length + HEX_PARITY_TOOLS.length + HEX_HEXFLO_TOOLS.length;
