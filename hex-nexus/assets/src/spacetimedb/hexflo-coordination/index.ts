...
const tablesSchema = __schema({
  hexflo_memory: __table({
    name: 'hexflo_memory',
    indexes: [
      { accessor: 'key', name: 'hexflo_memory_key_idx_btree', algorithm: 'btree', columns: [
        'key',
      ] },
    ],
    constraints: [
  ...
  swarm: __table({
    name: 'swarm',
    indexes: [
      { accessor: 'id', name: 'swarm_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'swarm_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, SwarmRow),
  swarm_agent: __table({
    name: 'swarm_agent',
    indexes: [
      { accessor: 'id', name: 'swarm_agent_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'swarm_agent_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, SwarmAgentRow),
  swarm_task: __table({
    name: 'swarm_task',
    indexes: [
      { accessor: 'id', name: 'swarm_task_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'swarm_task_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, SwarmTaskRow),
});
