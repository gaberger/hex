...
//!
//! Priority: `HEX_STATE_BACKEND` env var > `.hex/state.json` file > default (SpacetimeDB localhost:3000).
...
/// 3. Default: SpacetimeDB at `http://localhost:3000` database `hex-nexus`
