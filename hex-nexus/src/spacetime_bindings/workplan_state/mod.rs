...
pub mod advance_phase_reducer;
pub mod start_workplan_reducer;
pub mod update_task_reducer;
pub mod workplan_execution_table;
pub mod workplan_execution_type;
pub mod workplan_task_table;
pub mod workplan_task_type;

pub use advance_phase_reducer::advance_phase;
pub use start_workplan_reducer::start_workplan;
pub use update_task_reducer::update_task;
pub use workplan_execution_table::*;
pub use workplan_execution_type::WorkplanExecution;
pub use workplan_task_table::*;
pub use workplan_task_type::WorkplanTask;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::AdvancePhase { .. } => "advance_phase",
            Reducer::StartWorkplan { .. } => "start_workplan",
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::AdvancePhase { workplan_id, phase } => {
                __sats::bsatn::to_vec(&advance_phase_reducer::AdvancePhaseArgs {
                    workplan_id: workplan_id.clone(),
                    phase: phase.clone(),
                })
            }
            Reducer::StartWorkplan { id, path } => {
                __sats::bsatn::to_vec(&start_workplan_reducer::StartWorkplanArgs {
                    id: id.clone(),
                    path: path.clone(),
                })
            }
            Reducer::UpdateTask {
                ...
                agent_id,
                result,
            } => __sats::bsatn::to_vec(&update_task_reducer::UpdateTaskArgs {
...
#[doc(hidden)]
pub struct DbUpdate {
    workplan_execution: __sdk::TableUpdate<WorkplanExecution>,
    workplan_task: __sdk::TableUpdate<WorkplanTask>,
}
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                "workplan_execution" => db_update
                    .workplan_execution
                    .append(workplan_execution_table::parse_table_update(table_update)?),
                "workplan_task" => db_update
                    .workplan_task
                    .append(workplan_task_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.workplan_execution = cache.apply_diff_to_table::<WorkplanExecution>(
            "workplan_execution",
            &self.workplan_execution,
        );
        diff.workplan_task =
            cache.apply_diff_to_table::<WorkplanTask>("workplan_task", &self.workplan_task);
...
pub struct AppliedDiff<'r> {
    workplan_execution: __sdk::TableAppliedDiff<'r, WorkplanExecution>,
    workplan_task: __sdk::TableAppliedDiff<'r, WorkplanTask>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<WorkplanExecution>(
            "workplan_execution",
            &self.workplan_execution,
            event,
        );
        callbacks.invoke_table_row_callbacks::<WorkplanTask>(
            "workplan_task",
            &self.workplan_task,
            event,
        );
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        workplan_execution_table::register_table(client_cache);
        workplan_task_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] = &["workplan_execution", "workplan_task"];
}
