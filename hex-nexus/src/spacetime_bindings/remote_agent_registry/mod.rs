...
pub mod remote_agent_table;
pub mod remote_agent_type;
pub mod inference_server_table;
pub mod inference_server_type;
pub mod code_gen_task_table;
pub mod code_gen_task_type;
pub mod register_remote_agent_reducer;
pub mod update_heartbeat_reducer;
pub mod assign_task_reducer;
pub mod complete_task_reducer;
pub mod reassign_task_reducer;

pub use remote_agent_table::*;
pub use remote_agent_type::RemoteAgent;
pub use inference_server_table::*;
pub use inference_server_type::InferenceServer;
pub use code_gen_task_table::*;
pub use code_gen_task_type::CodeGenTask;
pub use register_remote_agent_reducer::register_remote_agent;
pub use update_heartbeat_reducer::update_heartbeat;
pub use assign_task_reducer::assign_task;
pub use complete_task_reducer::complete_task;
pub use reassign_task_reducer::reassign_task;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::RegisterRemoteAgent { .. } => "register_remote_agent",
            Reducer::UpdateHeartbeat { .. } => "update_heartbeat",
            Reducer::AssignTask { .. } => "assign_task",
            Reducer::CompleteTask { .. } => "complete_task",
            Reducer::ReassignTask { .. } => "reassign_task",
            _ => unreachable!(),
        }
    }
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::RegisterRemoteAgent {
                ...
                capabilities_json,
                tunnel_id,
            } => __sats::bsatn::to_vec(&register_remote_agent_reducer::RegisterRemoteAgentArgs {
            ...
            Reducer::UpdateHeartbeat {
                agent_id,
                timestamp,
            } => __sats::bsatn::to_vec(&update_heartbeat_reducer::UpdateHeartbeatArgs {
                agent_id: agent_id.clone(),
            ...
            Reducer::AssignTask {
                task_id,
                agent_id,
            } => __sats::bsatn::to_vec(&assign_task_reducer::AssignTaskArgs {
            ...
            Reducer::ReassignTask {
                task_id,
                new_agent_id,
            } => __sats::bsatn::to_vec(&reassign_task_reducer::ReassignTaskArgs {
                task_id: task_id.clone(),
...
#[doc(hidden)]
pub struct DbUpdate {
    remote_agent: __sdk::TableUpdate<RemoteAgent>,
    inference_server: __sdk::TableUpdate<InferenceServer>,
    code_gen_task: __sdk::TableUpdate<CodeGenTask>,
}
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                "remote_agent" => db_update
                    .remote_agent
                    .append(remote_agent_table::parse_table_update(table_update)?),
                "inference_server" => db_update
                    .inference_server
                    .append(inference_server_table::parse_table_update(table_update)?),
                "code_gen_task" => db_update
                    .code_gen_task
                    .append(code_gen_task_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.remote_agent = cache.apply_diff_to_table::<RemoteAgent>("remote_agent", &self.remote_agent);
        diff.inference_server =
            cache.apply_diff_to_table::<InferenceServer>("inference_server", &self.inference_server);
        diff.code_gen_task =
            cache.apply_diff_to_table::<CodeGenTask>("code_gen_task", &self.code_gen_task);
...
pub struct AppliedDiff<'r> {
    remote_agent: __sdk::TableAppliedDiff<'r, RemoteAgent>,
    inference_server: __sdk::TableAppliedDiff<'r, InferenceServer>,
    code_gen_task: __sdk::TableAppliedDiff<'r, CodeGenTask>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<RemoteAgent>("remote_agent", &self.remote_agent, event);
        callbacks.invoke_table_row_callbacks::<InferenceServer>(
            "inference_server",
            &self.inference_server,
            event,
        );
        callbacks.invoke_table_row_callbacks::<CodeGenTask>(
            "code_gen_task",
            &self.code_gen_task,
            event,
        );
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        remote_agent_table::register_table(client_cache);
        inference_server_table::register_table(client_cache);
        code_gen_task_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] = &["remote_agent", "inference_server", "code_gen_task"];
}
