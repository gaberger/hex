...
pub mod decay_patterns_reducer;
pub mod record_reward_reducer;
pub mod rl_experience_table;
pub mod rl_experience_type;
pub mod rl_pattern_table;
pub mod rl_pattern_type;
pub mod rl_q_entry_table;
pub mod rl_q_entry_type;
pub mod select_action_reducer;
pub mod store_pattern_reducer;

pub use decay_patterns_reducer::decay_patterns;
pub use record_reward_reducer::record_reward;
pub use rl_experience_table::*;
pub use rl_experience_type::RlExperience;
pub use rl_pattern_table::*;
pub use rl_pattern_type::RlPattern;
pub use rl_q_entry_table::*;
pub use rl_q_entry_type::RlQEntry;
pub use select_action_reducer::select_action;
pub use store_pattern_reducer::store_pattern;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::DecayPatterns => "decay_patterns",
            Reducer::RecordReward { .. } => "record_reward",
            Reducer::SelectAction { .. } => "select_action",
            Reducer::StorePattern { .. } => "store_pattern",
            _ => unreachable!(),
        }
    }
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::DecayPatterns => {
                __sats::bsatn::to_vec(&decay_patterns_reducer::DecayPatternsArgs {})
            }
            Reducer::RecordReward {
                state_key,
                action,
                reward,
                next_state_key,
            } => __sats::bsatn::to_vec(&record_reward_reducer::RecordRewardArgs {
                state_key: state_key.clone(),
                action: action.clone(),
                reward: reward.clone(),
                next_state_key: next_state_key.clone(),
            }),
            Reducer::SelectAction { state_key } => {
                __sats::bsatn::to_vec(&select_action_reducer::SelectActionArgs {
                    state_key: state_key.clone(),
                })
            }
            Reducer::StorePattern {
                category,
                content,
                confidence,
            } => __sats::bsatn::to_vec(&store_pattern_reducer::StorePatternArgs {
...
#[doc(hidden)]
pub struct DbUpdate {
    rl_experience: __sdk::TableUpdate<RlExperience>,
    rl_pattern: __sdk::TableUpdate<RlPattern>,
    rl_q_entry: __sdk::TableUpdate<RlQEntry>,
}
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                "rl_experience" => db_update
                    .rl_experience
                    .append(rl_experience_table::parse_table_update(table_update)?),
                "rl_pattern" => db_update
                    .rl_pattern
                    .append(rl_pattern_table::parse_table_update(table_update)?),
                "rl_q_entry" => db_update
                    .rl_q_entry
                    .append(rl_q_entry_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.rl_experience =
            cache.apply_diff_to_table::<RlExperience>("rl_experience", &self.rl_experience);
        diff.rl_pattern = cache.apply_diff_to_table::<RlPattern>("rl_pattern", &self.rl_pattern);
        diff.rl_q_entry = cache.apply_diff_to_table::<RlQEntry>("rl_q_entry", &self.rl_q_entry);
...
pub struct AppliedDiff<'r> {
    rl_experience: __sdk::TableAppliedDiff<'r, RlExperience>,
    rl_pattern: __sdk::TableAppliedDiff<'r, RlPattern>,
    rl_q_entry: __sdk::TableAppliedDiff<'r, RlQEntry>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<RlExperience>(
            "rl_experience",
            &self.rl_experience,
            event,
        );
        callbacks.invoke_table_row_callbacks::<RlPattern>("rl_pattern", &self.rl_pattern, event);
        callbacks.invoke_table_row_callbacks::<RlQEntry>("rl_q_entry", &self.rl_q_entry, event);
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        rl_experience_table::register_table(client_cache);
        rl_pattern_table::register_table(client_cache);
        rl_q_entry_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] = &["rl_experience", "rl_pattern", "rl_q_entry"];
}
