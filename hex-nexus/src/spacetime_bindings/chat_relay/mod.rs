...
pub mod archive_conversation_reducer;
pub mod clear_conversation_reducer;
pub mod conversation_table;
pub mod conversation_type;
pub mod create_conversation_reducer;
pub mod message_table;
pub mod message_type;
pub mod send_message_reducer;

pub use archive_conversation_reducer::archive_conversation;
pub use clear_conversation_reducer::clear_conversation;
pub use conversation_table::*;
pub use conversation_type::Conversation;
pub use create_conversation_reducer::create_conversation;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::ArchiveConversation { .. } => "archive_conversation",
            Reducer::ClearConversation { .. } => "clear_conversation",
            Reducer::CreateConversation { .. } => "create_conversation",
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::ArchiveConversation { conversation_id } => {
                __sats::bsatn::to_vec(&archive_conversation_reducer::ArchiveConversationArgs {
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.conversation =
            cache.apply_diff_to_table::<Conversation>("conversation", &self.conversation);
