...
pub enum PlanAction {
    ...
    Reconcile {
        ...
        /// fails. Heals JSONs corrupted by the pre-ADR-2604142201 reconcile
...
// Reconcile logic extracted to reconcile.rs (ADR-2604142201).
...
async fn reconcile_all(strict: bool, json: bool) -> anyhow::Result<()> {
    ...
    // Evidence-schema cutoff: ADR-2604142201 (Reconcile must verify file
