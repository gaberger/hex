# Implement mock adapter for historical data access

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Implement mock adapter for historical data access — built with hexagonal (ports & adapters) architecture in TypeScript.
