# Implement domain models (Driver, Race, Constructor) in domain layer

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Implement domain models (Driver, Race, Constructor) in domain layer — built with hexagonal (ports & adapters) architecture in TypeScript.
