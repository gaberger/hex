# Plan: P1.3: Update composition root to inject Ergast adapter into use cases

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Plan: P1.3: Update composition root to inject Ergast adapter into use cases — built with hexagonal (ports & adapters) architecture in TypeScript.
