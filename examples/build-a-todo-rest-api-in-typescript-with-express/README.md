# Implement Todo REST API with Hexagonal Layers

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Implement Todo REST API with Hexagonal Layers — built with hexagonal (ports & adapters) architecture in TypeScript.
