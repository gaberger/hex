# Wire ConsoleAdapter to PrintHelloUseCase via composition-root

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Wire ConsoleAdapter to PrintHelloUseCase via composition-root — built with hexagonal (ports & adapters) architecture in TypeScript.
