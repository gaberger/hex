# Implement CLI Primary Adapter with FizzBuzz Port

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Implement CLI Primary Adapter with FizzBuzz Port — built with hexagonal (ports & adapters) architecture in TypeScript.
