# Leaderboard Service with Go API & TypeScript CLI

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Leaderboard Service with Go API & TypeScript CLI — built with hexagonal (ports & adapters) architecture in TypeScript.
