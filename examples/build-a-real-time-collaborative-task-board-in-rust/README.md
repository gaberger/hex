# Build a Real-Time Collaborative Task Board in Rust

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Build a Real-Time Collaborative Task Board in Rust — built with hexagonal (ports & adapters) architecture in Rust.
