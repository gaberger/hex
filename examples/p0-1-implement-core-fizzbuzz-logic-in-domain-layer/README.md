# Implement core FizzBuzz logic in domain layer

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Implement core FizzBuzz logic in domain layer — built with hexagonal (ports & adapters) architecture in TypeScript.
