# Implement Simple Todo REST API with Hexagonal Architecture

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Implement Simple Todo REST API with Hexagonal Architecture — built with hexagonal (ports & adapters) architecture in TypeScript.
