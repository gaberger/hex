# URL Shortener REST API with In-Memory Storage

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

URL Shortener REST API with In-Memory Storage — built with hexagonal (ports & adapters) architecture in TypeScript.
