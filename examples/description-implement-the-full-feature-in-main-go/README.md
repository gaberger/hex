# Implement URL Shortener REST API as a Single-Binary Go Project

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Implement URL Shortener REST API as a Single-Binary Go Project — built with hexagonal (ports & adapters) architecture in TypeScript.
