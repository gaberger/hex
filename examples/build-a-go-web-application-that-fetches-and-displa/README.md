# Plan: build a go web application that fetches and displays F1 race standings

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Plan: build a go web application that fetches and displays F1 race standings — built with hexagonal (ports & adapters) architecture in Go.
