# Financial Services Portfolio Management Platform

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Financial Services Portfolio Management Platform — built with hexagonal (ports & adapters) architecture in TypeScript.
