# Plan: P1.2: Create use cases that utilize the Ergast adapter in usecases/ergast

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Plan: P1.2: Create use cases that utilize the Ergast adapter in usecases/ergast — built with hexagonal (ports & adapters) architecture in TypeScript.
