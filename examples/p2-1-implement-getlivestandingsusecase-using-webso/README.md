# Implement GetLiveStandingsUseCase with WebSocketAdapter

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Implement GetLiveStandingsUseCase with WebSocketAdapter — built with hexagonal (ports & adapters) architecture in TypeScript.
