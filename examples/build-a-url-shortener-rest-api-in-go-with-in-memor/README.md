# Go URL Shortener with In-Memory Storage and REST API

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Go URL Shortener with In-Memory Storage and REST API — built with hexagonal (ports & adapters) architecture in Go.
