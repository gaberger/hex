# Build a URL Shortener REST API in Go with In-Memory Storage

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Build a URL Shortener REST API in Go with In-Memory Storage — built with hexagonal (ports & adapters) architecture in Go.
