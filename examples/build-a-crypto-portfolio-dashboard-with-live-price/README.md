# Build Crypto Portfolio Dashboard with Live Charts

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Build Crypto Portfolio Dashboard with Live Charts — built with hexagonal (ports & adapters) architecture in TypeScript.
