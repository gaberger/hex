# Plan: build a hello world CLI in rust that prints hello

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Plan: build a hello world CLI in rust that prints hello — built with hexagonal (ports & adapters) architecture in Rust.
