# Define PrintHelloUseCase interface in usecases/ layer specifying signature

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Define PrintHelloUseCase interface in usecases/ layer specifying signature — built with hexagonal (ports & adapters) architecture in TypeScript.
