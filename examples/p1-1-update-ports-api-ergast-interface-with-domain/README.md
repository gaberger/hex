# Plan: P1.1: Update ports/api/ergast interface with domain-specific methods

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Plan: P1.1: Update ports/api/ergast interface with domain-specific methods — built with hexagonal (ports & adapters) architecture in TypeScript.
