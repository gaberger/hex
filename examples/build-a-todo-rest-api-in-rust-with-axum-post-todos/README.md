# Implement Todo REST API with Axum and Hexagonal Architecture

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Implement Todo REST API with Axum and Hexagonal Architecture — built with hexagonal (ports & adapters) architecture in Rust.
