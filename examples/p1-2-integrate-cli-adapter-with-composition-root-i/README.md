# Integrate CLI adapter with composition root in Go

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Integrate CLI adapter with composition root in Go — built with hexagonal (ports & adapters) architecture in TypeScript.
