# Plan: P2.1: Create GetLiveStandingsUseCase in usecases layer

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Plan: P2.1: Create GetLiveStandingsUseCase in usecases layer — built with hexagonal (ports & adapters) architecture in TypeScript.
