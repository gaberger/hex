# Plan: P2.1: Implement primary adapter for React frontend (REST client for F1 data)

> Generated by `hex dev` — hexagonal architecture development pipeline

## Overview

Plan: P2.1: Implement primary adapter for React frontend (REST client for F1 data) — built with hexagonal (ports & adapters) architecture in TypeScript.
