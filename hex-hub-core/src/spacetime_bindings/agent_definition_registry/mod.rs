...
pub mod agent_definition_table;
pub mod agent_definition_type;
pub mod agent_definition_version_table;
pub mod agent_definition_version_type;
pub mod get_definition_by_name_reducer;
pub mod register_definition_reducer;
pub mod remove_definition_reducer;
pub mod update_definition_reducer;

pub use agent_definition_table::*;
pub use agent_definition_type::AgentDefinition;
pub use agent_definition_version_table::*;
pub use agent_definition_version_type::AgentDefinitionVersion;
pub use get_definition_by_name_reducer::get_definition_by_name;
pub use register_definition_reducer::register_definition;
pub use remove_definition_reducer::remove_definition;
pub use update_definition_reducer::update_definition;
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(raw: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        match &raw.reducer_name[..] {
            "get_definition_by_name" => Ok(__sdk::parse_reducer_args::<get_definition_by_name_reducer::GetDefinitionByNameArgs>("get_definition_by_name", &raw.args)?.into()),
            "register_definition" => Ok(__sdk::parse_reducer_args::<register_definition_reducer::RegisterDefinitionArgs>("register_definition", &raw.args)?.into()),
            "remove_definition" => Ok(__sdk::parse_reducer_args::<remove_definition_reducer::RemoveDefinitionArgs>("remove_definition", &raw.args)?.into()),
            "update_definition" => Ok(__sdk::parse_reducer_args::<update_definition_reducer::UpdateDefinitionArgs>("update_definition", &raw.args)?.into()),
            unknown => Err(
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::GetDefinitionByName { .. } => "get_definition_by_name",
            Reducer::RegisterDefinition { .. } => "register_definition",
            Reducer::RemoveDefinition { .. } => "remove_definition",
            Reducer::UpdateDefinition { .. } => "update_definition",
            _ => unreachable!(),
        }
    }
}
...
#[doc(hidden)]
pub struct DbUpdate {
    agent_definition: __sdk::TableUpdate<AgentDefinition>,
    agent_definition_version: __sdk::TableUpdate<AgentDefinitionVersion>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "agent_definition" => db_update
                    .agent_definition
                    .append(agent_definition_table::parse_table_update(table_update)?),
                "agent_definition_version" => db_update.agent_definition_version.append(
                    agent_definition_version_table::parse_table_update(table_update)?,
                ),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.agent_definition = cache
            .apply_diff_to_table::<AgentDefinition>("agent_definition", &self.agent_definition);
        diff.agent_definition_version = cache.apply_diff_to_table::<AgentDefinitionVersion>(
...
pub struct AppliedDiff<'r> {
    agent_definition: __sdk::TableAppliedDiff<'r, AgentDefinition>,
    agent_definition_version: __sdk::TableAppliedDiff<'r, AgentDefinitionVersion>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<AgentDefinition>(
            "agent_definition",
            &self.agent_definition,
            event,
        );
        callbacks.invoke_table_row_callbacks::<AgentDefinitionVersion>(
            "agent_definition_version",
            &self.agent_definition_version,
            event,
        );
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        agent_definition_table::register_table(client_cache);
        agent_definition_version_table::register_table(client_cache);
    }
}
