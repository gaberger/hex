...
pub mod compute_node_table;
pub mod compute_node_type;
pub mod decrement_agents_reducer;
pub mod increment_agents_reducer;
pub mod register_node_reducer;
pub mod remove_node_reducer;
pub mod update_health_reducer;

pub use compute_node_table::*;
pub use compute_node_type::ComputeNode;
pub use decrement_agents_reducer::decrement_agents;
pub use increment_agents_reducer::increment_agents;
pub use register_node_reducer::register_node;
pub use remove_node_reducer::remove_node;
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(raw: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        match &raw.reducer_name[..] {
            "decrement_agents" => Ok(__sdk::parse_reducer_args::<decrement_agents_reducer::DecrementAgentsArgs>("decrement_agents", &raw.args)?.into()),
            "increment_agents" => Ok(__sdk::parse_reducer_args::<increment_agents_reducer::IncrementAgentsArgs>("increment_agents", &raw.args)?.into()),
            "register_node" => Ok(__sdk::parse_reducer_args::<register_node_reducer::RegisterNodeArgs>("register_node", &raw.args)?.into()),
            "remove_node" => Ok(__sdk::parse_reducer_args::<remove_node_reducer::RemoveNodeArgs>("remove_node", &raw.args)?.into()),
            "update_health" => Ok(__sdk::parse_reducer_args::<update_health_reducer::UpdateHealthArgs>("update_health", &raw.args)?.into()),
            unknown => Err(
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::DecrementAgents { .. } => "decrement_agents",
            Reducer::IncrementAgents { .. } => "increment_agents",
            Reducer::RegisterNode { .. } => "register_node",
            Reducer::RemoveNode { .. } => "remove_node",
...
#[doc(hidden)]
pub struct DbUpdate {
    compute_node: __sdk::TableUpdate<ComputeNode>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "compute_node" => db_update
                    .compute_node
                    .append(compute_node_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.compute_node =
            cache.apply_diff_to_table::<ComputeNode>("compute_node", &self.compute_node);
...
pub struct AppliedDiff<'r> {
    compute_node: __sdk::TableAppliedDiff<'r, ComputeNode>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<ComputeNode>(
            "compute_node",
            &self.compute_node,
            event,
        );
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        compute_node_table::register_table(client_cache);
    }
}
