    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::RegisterSkill {
                ...
                source,
                timestamp,
            } => __sats::bsatn::to_vec(&register_skill_reducer::RegisterSkillArgs {
                id: id.clone(),
                name: name.clone(),
                description: description.clone(),
                triggers_json: triggers_json.clone(),
                body: body.clone(),
                source: source.clone(),
                timestamp: timestamp.clone(),
            }),
            Reducer::RemoveSkill { id } => {
                __sats::bsatn::to_vec(&remove_skill_reducer::RemoveSkillArgs { id: id.clone() })
            }
            Reducer::SearchSkills {
                trigger_type,
                query,
            } => __sats::bsatn::to_vec(&search_skills_reducer::SearchSkillsArgs {
            ...
            Reducer::UpdateSkill {
                ...
                body,
                timestamp,
            } => __sats::bsatn::to_vec(&update_skill_reducer::UpdateSkillArgs {
                id: id.clone(),
                description: description.clone(),
                triggers_json: triggers_json.clone(),
                body: body.clone(),
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    const ALL_TABLE_NAMES: &'static [&'static str] = &["skill", "skill_trigger_index"];
}
