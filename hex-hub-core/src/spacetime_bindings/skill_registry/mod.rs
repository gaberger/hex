...
pub mod register_skill_reducer;
pub mod remove_skill_reducer;
pub mod search_skills_reducer;
pub mod skill_table;
pub mod skill_trigger_index_table;
pub mod skill_trigger_index_type;
pub mod skill_type;
pub mod update_skill_reducer;

pub use register_skill_reducer::register_skill;
pub use remove_skill_reducer::remove_skill;
pub use search_skills_reducer::search_skills;
pub use skill_table::*;
pub use skill_trigger_index_table::*;
pub use skill_trigger_index_type::SkillTriggerIndex;
pub use skill_type::Skill;
pub use update_skill_reducer::update_skill;
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(raw: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        match &raw.reducer_name[..] {
            "register_skill" => Ok(__sdk::parse_reducer_args::<register_skill_reducer::RegisterSkillArgs>("register_skill", &raw.args)?.into()),
            "remove_skill" => Ok(__sdk::parse_reducer_args::<remove_skill_reducer::RemoveSkillArgs>("remove_skill", &raw.args)?.into()),
            "search_skills" => Ok(__sdk::parse_reducer_args::<search_skills_reducer::SearchSkillsArgs>("search_skills", &raw.args)?.into()),
            "update_skill" => Ok(__sdk::parse_reducer_args::<update_skill_reducer::UpdateSkillArgs>("update_skill", &raw.args)?.into()),
            unknown => Err(
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::RegisterSkill { .. } => "register_skill",
            Reducer::RemoveSkill { .. } => "remove_skill",
            Reducer::SearchSkills { .. } => "search_skills",
            Reducer::UpdateSkill { .. } => "update_skill",
            _ => unreachable!(),
        }
    }
}
...
pub struct DbUpdate {
    ...
    skill_trigger_index: __sdk::TableUpdate<SkillTriggerIndex>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                ...
                "skill_trigger_index" => db_update
                    .skill_trigger_index
                    .append(skill_trigger_index_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.skill = cache.apply_diff_to_table::<Skill>("skill", &self.skill);
        diff.skill_trigger_index = cache.apply_diff_to_table::<SkillTriggerIndex>(
            "skill_trigger_index",
            &self.skill_trigger_index,
        );
...
pub struct AppliedDiff<'r> {
    ...
    skill_trigger_index: __sdk::TableAppliedDiff<'r, SkillTriggerIndex>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<SkillTriggerIndex>(
            "skill_trigger_index",
            &self.skill_trigger_index,
            event,
        );
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        skill_trigger_index_table::register_table(client_cache);
    }
}
