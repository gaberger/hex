...
**Supersedes:** Implicit single-database design documented in ADR-2026-03-23-1400 D5.
...
ADR-2026-03-23-1400 mitigated this by publishing only `hexflo-coordination` (the mega-module with 15 core tables). This leaves 17 modules dormant:
...
- ADR-2026-03-23-1400: SpacetimeDB Operational Resilience (predecessor)
