# ADR-2026-03-22-2229: CLI / MCP / Dashboard Parity Investigation
...
- ADR-2026-03-25-0838: CLI/MCP Shared Implementation — One Function, Two Skins (root-cause fix for drift)
