# ADR-2026-03-23-2230: Tool Call Tracking in SpacetimeDB
...
**Supersedes:** None (extends ADR-2026-03-23-2220, ADR-027)

## Context

The `hex report` command (ADR-2026-03-23-2220) assembles audit trails from local session files. Each session now tracks a `tool_calls` array with per-call metadata:
...
```json
{
  ...
  "duration_ms": 26365,
  "status": "ok",
  "detail": "docs/adrs/ADR-2026-03-23-2200-...md"
}
```
...
- ADR-2026-03-23-2220: Developer Audit Report
