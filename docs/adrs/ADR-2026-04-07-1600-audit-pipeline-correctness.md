...
**Supersedes:** Partial fixes in ADR-2026-04-07-1300 (P0–P1 completed; these bugs were P2 regressions)
...
- ADR-2026-04-07-1300 — Unified hex dev audit trail via SpacetimeDB (parent ADR)
- ADR-2026-04-07-0400 — Swarm code quality improvements (fixer loop detection context)
