...
Tracked in: ADR-2026-03-24-2100 (hex-cli integration testing).
...
- ADR-2026-03-22-2229: CLI / MCP / Dashboard Parity Investigation (gap audit)
- ADR-2026-03-24-2100: hex-cli Integration Testing
