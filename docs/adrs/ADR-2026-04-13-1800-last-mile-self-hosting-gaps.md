# ADR-2026-04-13-1800: Last-Mile Self-Hosting Gaps — hex Must Use hex
...
|---|-----|---------------|------------|
| G1 | **Stale `.hex/task.json` blocks commits** | Pre-commit hook rejected files from new task because task.json was scoped to prior task (P4.1 → ADR-2026-04-13-1630) | No auto-reset when task context changes |
...
- **ADR-2026-03-24-1700** (Worktree Enforcement) — enforces worktrees but no file-overlap guard
- **ADR-2026-04-05-1700** (Enforce Workplan Gates) — gates exist but status doesn't reconcile with git
- **ADR-2026-04-13-1500** (AIOS Experience) — brief/pulse exist but brief is unbounded
...
- ADR-2026-03-24-1700: Worktree Enforcement in Agent Hooks
- ADR-2026-04-05-1700: Enforce Workplan Gates
- ADR-2026-04-13-1500: AIOS Developer Experience
