...
- Feed the Q-table into the idle-research swarm (ADR-2026-04-15-1200) as a code-quality signal
...
- Provides a clean signal source for the idle-research swarm (ADR-2026-04-15-1200) to flag drift.
