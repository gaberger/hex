...
The user asked: *"we need an active swarm loop to be assessing, categorizing, reporting and executing against this"* — referring to the memory health, not code health (idle-research swarm, ADR-2026-04-15-1200).
