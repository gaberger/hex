...
**Relates to:** ADR-004 (Swarm Worktrees), ADR-050 (Hook-Enforced Lifecycle), ADR-2026-03-22-1939 (Mandatory Swarm Tracking), ADR-061 (Workplan Lifecycle)
...
**ADR-004** defined the worktree model. **ADR-050** defined the hook pipeline. **ADR-2026-03-22-1939** enforced `HEXFLO_TASK:` in prompts. But none of them connected the dots: **no hook validates that the agent actually runs in its task's assigned worktree**.
...
- Incident: OpenRouter integration (ADR-2026-03-23-1600) — 9 agents on main, no worktree isolation
