# ADR-2026-03-24-1230: Neural Network Encoding in SpacetimeDB WASM

**Status:** Accepted
**Implementation-Present:** 2026-05-12 by auto-scan — evidence: hex-nexus/src/neural_lab_quant.rs
**Date:** 2026-03-24
...
| Single monolithic module | Violates per-module database separation (ADR-2026-03-23-1500) |
...
- Scheduled reducers cannot cross module boundaries — if rl-engine is a separate database (ADR-2026-03-23-1500), strategy reads require hex-nexus to bridge the data
