...
- ADR-2026-03-24-1800: Swarm lifecycle management
- **ADR-2026-03-24-0130**: Declarative Swarm Agent Behavior — this ADR is a prerequisite. The swarm composition YAML (section 8 of ADR-2026-03-24-0130) declares which agent roles participate in a swarm. This ADR provides the ownership and conflict-safety guarantees that make declarative multi-agent swarms safe to execute across remote nodes.
