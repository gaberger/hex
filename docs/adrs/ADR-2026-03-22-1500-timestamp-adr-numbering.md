...
1. **Race condition**: When two agents (or a human and an agent) create ADRs concurrently, both scan the directory, both compute the same `max + 1`, and both write a file with the same number. This already happened — `ADR-059-canonical-project-identity.md` and `ADR-2026-03-22-1522-embedded-asset-bundle.md` both exist.
...
- Existing collision: `ADR-059-canonical-project-identity.md` and `ADR-2026-03-22-1522-embedded-asset-bundle.md`
