...
The hook-first architecture migration (ADR-2026-04-01-2110) creates a natural event source: every PreToolUse/PostToolUse hook call already has the full tool name, arguments, and result available in the hook environment.
...
- ADR-2026-04-01-2110 — hook-first enforcement (provides the PreToolUse/PostToolUse event source)
