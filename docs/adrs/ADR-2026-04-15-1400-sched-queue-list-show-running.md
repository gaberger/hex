# ADR-2026-04-15-1400 — `hex sched queue list` Shows Running Tasks

**Status:** Accepted
**Date:** 2026-04-15
**Related:** ADR-2026-04-15-0000 (brain→sched rename), ADR-2026-04-15-1330 (per-project queue isolation)
