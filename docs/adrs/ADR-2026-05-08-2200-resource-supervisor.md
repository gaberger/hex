# ADR-2026-05-08-2200 — Resource-Aware Supervisor (process_observation + tick)

Status: **Accepted** (implementation in flight)
Date: 2026-05-08
Supersedes: none
Related: ADR-027 (HexFlo coordination), ADR-2026-05-08-1126 (worktree-mandatory merge gate), feedback_supervisor_in_stdb, feedback_cpu_pinning_diagnosis
