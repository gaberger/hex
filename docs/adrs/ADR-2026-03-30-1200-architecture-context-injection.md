...
```json
{
  ...
  "active_adrs": ["ADR-2026-03-30-1125: use flat Go layout for standalone CLIs"],
...
Active ADRs: ADR-2026-03-30-1125 (flat Go layout for standalone CLIs)
---
```
...
- ADR-2026-03-29-1900: Docker Worker First-Class Execution (worker spawn architecture)
- ADR-2026-03-30-0100: hex-agent SpacetimeDB WebSocket Client
