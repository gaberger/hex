# ADR-2026-04-13-1630: Code-First Execution — Inference as Accelerator, Not Gate
...
**Supersedes:** None (refines ADR-2026-04-11-2000 Standalone Dispatch)
...
2. **Require Claude Code** — Abandons the standalone path. Unacceptable per ADR-2026-04-11-2000.
...
When no hint is provided, the executor SHALL classify based on task title heuristics (same approach as T1/T2/T3 tier routing in ADR-2026-04-13-1500).
...
- ADR-2026-04-11-2000: Standalone Dispatch (establishes standalone as first-class)
- ADR-2026-04-13-1500: AIOS Developer Experience (T1/T2/T3 tier routing)
- ADR-2026-04-13-0010: Worker Local Inference Discovery
