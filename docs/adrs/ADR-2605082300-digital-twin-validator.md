# ADR-2605082300 — Digital-Twin Auto-Validator

Status: **Accepted** (implementation in flight)
Date: 2026-05-08
Related: ADR-2605082200 (resource supervisor), ADR-2605081126 (merge gate), feedback_no_persona_fabrication, feedback_no_asking_for_permission, feedback_homeostasis

## Context

After ADR-2605082200 (commitments) and ADR-2605082200 (resource supervisor),
