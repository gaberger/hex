...
- ADR-2026-03-23-2340 — validate loop (pre-condition: code phase must complete)
- ADR-2026-03-24-1126 — TUI CLI surrogate (traceability)
- ADR-2026-03-31-1000 — workflow reliability hardening (superseded by this ADR for phase gates)
