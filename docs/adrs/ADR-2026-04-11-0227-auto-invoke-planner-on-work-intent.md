...
- **Related ADRs:**
  ...
  - ADR-2026-04-10-1200: Workplan file scaffolding (complementary — this ADR creates the workplan, that ADR scaffolds files the workplan references)
  - ADR-2026-04-05-1700: Enforce workplan gates (defines the `mandatory` mode this ADR re-uses)
