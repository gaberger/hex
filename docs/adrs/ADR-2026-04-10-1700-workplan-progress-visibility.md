# ADR-2026-04-10-1700: Workplan Progress Visibility via SpacetimeDB
...
- **Depends on:** ADR-2026-04-10-1600 (SpacetimeDB Workplan Coordination)
...
2. **WebSocket subscription** — ADR-2026-04-10-1600 already adds this
3. **hex status** — too generic, not workplan-specific

This ADR adds dedicated visibility on top of ADR-2026-04-10-1600's coordination infrastructure.