...
**Date:** 2026-04-15
**Accepted:** 2026-05-04
**Related:** ADR-2026-04-15-0000 (brain→sched rename), ADR-2026-04-14-1400 (sched evidence-guard), ADR-2026-04-15-1200 (idle research swarm), ADR-2026-04-14-2200 (reconcile evidence verification)
...
<workspace_root>/.hex/sched/
  ...
  last_research_sweep     # Per-project sweep throttle (ADR-2026-04-15-1200)
```
