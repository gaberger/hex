...
**Note:** ADR-2604271100 (sched improver) was scoped but never written. Treat references as conceptual; the dependency was satisfied by the broader sched-daemon work in ADR-2604150000 and successors.
