...
**Supersedes:** None (complements ADR-2026-03-22-1522 `hex assets` embedded-asset CLI, ADR-049 MCP/settings template)
...
- The reverse direction (live → embedded), which does not have a
  ...
  P7 of the workplan.
- Related ADRs: ADR-2026-03-22-1522 (hex assets embedded-asset CLI introduction),
