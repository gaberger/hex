...
**Supersedes:** ADR-2026-04-10-1900 (extends with runtime polling)

## Context

### Current State

ADR-2026-04-10-1900 implemented the steering/interrupt API:
...
- ADR-2026-04-10-1900: Steering/Interrupt API Implementation
