...
hex's enforcement pipeline (ADR-2026-03-22-1939) relies on Claude Code hooks:
...
- Client hooks (ADR-2026-03-22-1939) remain as first-line defense for Claude Code — defense in depth
...
- ADR-2026-03-22-1939: Mandatory Swarm Tracking (client-side enforcement via Claude Code hooks)
