...
**Related:** ADR-001 (hexagonal architecture), ADR-2603283000 (Rust workspace boundary analysis), ADR-2604142201-reconcile-evidence-verification (same pattern: test the rejection, not just the accept)
...
- ADR-2604142201-reconcile-evidence-verification — same principle applied to the reconciler: test the rejection, not just the accept
