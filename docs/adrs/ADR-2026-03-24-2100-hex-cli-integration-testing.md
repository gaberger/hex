# ADR-2026-03-24-2100: Comprehensive hex-cli Integration Testing
...
- **No output contract validation**: table formatting (ADR-2026-03-24-1226), JSON mode, and error messages are untested
...
- Output contracts are explicit and verifiable — ADR-2026-03-24-1226 (`tabled` formatting) is now testable
...
- Commands that do complex TUI output (ratatui, ADR-2026-03-24-1500) are harder to assert on
...
- ADR-2026-03-24-1226: Structured CLI Table Output (`tabled`) — contracts this testing ADR validates
