...
ADR-2026-04-13-1500 defined 4 UX layers (Pulse/Brief/Console/Override) but the CLI doesn't enforce them — every command is top-level, equally visible.
...
- ADR-2026-04-13-1500: AIOS Developer Experience (4-layer UX)
- ADR-2026-04-13-1945: Brain Self-Consistency Daemon (`hex doctor validate`)
