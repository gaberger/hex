...
**Status:** Accepted (2026-05-05, adr-reviewer follow-up)
**Date:** 2026-04-26
...
- `STASH_REASONER_MODEL=hex/t2.5` resolves to the configured T2.5 model (`devstral-small-2:24b` by default, per ADR-2026-04-12-0202).
...
- ADR-2026-04-05-1800 — memory scope capability checks (P1)
- ADR-2026-04-11-2000 — memory port split (P5)
- ADR-2026-04-12-0202, ADR-2026-04-13-1630 — tiered inference routing (T1/T2/T2.5/T3)
