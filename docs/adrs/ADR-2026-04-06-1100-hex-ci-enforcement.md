...
- ADR-2026-04-05-1700: Enforce Workplan Gates (introduced gate infrastructure in executor)
- ADR-2026-04-02-1215: SpacetimeDB direct query CLI (the feature whose drift triggered this ADR)
