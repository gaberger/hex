...
3. **CI integration** (GitHub Actions, ADR-2026-05-02-0830 compliance)  
...
- **ADR-2026-05-02-0830**: hex CI Enforcement — Done-Conditions, `hex ci`, and Deployed Workflows (CI integration)
