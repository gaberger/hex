...
**Supersedes:** ADR-2026-03-28-2000 (partially — builds on Docker sandbox foundation), ADR-2026-03-29-1900 (partially — builds on worker execution)
...
| **Container isolation** | Docker microVMs | ADR-2026-03-28-2000 Docker Sandbox | **Medium — not wired** |
...
4. **Docker worker wiring** — ADR-2026-03-29-1900 phase P4 (the `if false &&` guard) is not done
...
5. **Inference routing** — model selection per complexity (ADR-2026-03-27-1000)
...
| P2a | ADR-2026-03-29-1900 P0: task metadata enrichment | Medium | ✅ Done |
| P2b | ADR-2026-03-29-1900 P1: real hex-coder worker | Medium | ✅ Done |
| P2c | ADR-2026-03-29-1900 P4: remove `if false &&` guard | Medium | ✅ Done |
...
- Docker workers become first-class (ADR-2026-03-29-1900 completes)
