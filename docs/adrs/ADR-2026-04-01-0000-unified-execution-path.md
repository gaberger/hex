...
ADR-2026-03-31-2210 introduced `claude -p --dangerously-skip-permissions` as a bypass when the Anthropic vault had no credits. This approach is **architecturally incorrect**:

- Bypasses RL model selection (ADR-031) — model is always whatever `claude` defaults to
- Bypasses HexFlo task tracking (ADR-2026-03-22-1939) — agents run invisibly
...
**Migration:**
- ADR-2026-03-31-2210 is retired. Remove `claude -p` subprocess code from `agent_manager.rs`
