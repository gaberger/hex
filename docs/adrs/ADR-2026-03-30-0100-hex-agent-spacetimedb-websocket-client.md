...
**REST polling + structured payload only** (ADR-2026-03-29-1900 approach): Fixes the task payload problem but leaves the polling latency, the 403/404 signal failures, and the inference fallback chain broken. Rejected as a partial fix.
