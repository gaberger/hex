# ADR-2026-04-26-1303: IModelProvider port + crate split (client / orchestrator / worker)
...
**Supersedes:** Partially supersedes ADR-2026-04-12-0202 (tier-aware routing) and ADR-2026-04-24-1820 (RL-aware model selection) — both retained as policies *over* the new port, not as a replacement for it.
...
- ADR-2026-04-12-0202 (tier-aware routing) is **retained** as the T1/T2/T2.5/T3 preset definitions over `Requirements`. ADR-2026-04-24-1820 (RL-aware selection) is **retained** as the default `RoutingPolicy` impl. Neither is rolled back; both are reframed.
...
- ADR-2026-04-12-0202 — Tier-aware routing (retained as preset definitions over `Requirements`)
- ADR-2026-04-24-1820 — RL-aware model selection (retained as default `RoutingPolicy` impl)
- ADR-2026-04-05-0900 — 7-module SpacetimeDB layout (this ADR proposes consolidating to 1–2)
