...
- [ADR-007](../adrs/ADR-007-notification-system.md) — Multi-channel notification system
- [ADR-008](../adrs/ADR-008-dogfooding.md) — Dogfooding hex on itself
- [ADR-009](../adrs/ADR-009-ruflo-required.md) — Ruflo as required dependency
- [ADR-010](../adrs/ADR-010-typescript-to-rust-migration.md) — TypeScript-to-Rust hybrid migration strategy
- [ADR-011](../adrs/ADR-011-coordination-multi-instance.md) — Coordination and multi-instance locking
- [ADR-012](../adrs/ADR-012-adr-lifecycle-tracking.md) — ADR lifecycle tracking
- [ADR-013](../adrs/ADR-013-secrets-management.md) — Secrets management with three backends
