 ...
 *
 * Value objects for post-build validation: behavioral specs, property tests,
 * smoke scenarios, sign conventions, and the validation verdict.
 *
 * These are domain types (pure data, no behavior) — owned by the domain layer.
 * The IValidationPort interface in ports/ imports these types.
 */
