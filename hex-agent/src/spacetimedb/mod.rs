...
pub mod agent_channel_type;
pub mod agent_message_type;
pub mod agent_typing_type;
pub mod clear_typing_reducer;
pub mod create_channel_reducer;
pub mod mark_read_reducer;
pub mod send_dm_reducer;
pub mod send_to_channel_reducer;
pub mod set_typing_reducer;
pub mod agent_channels_table;
pub mod agent_messages_table;
pub mod agent_typing_table;

pub use agent_channel_type::AgentChannel;
pub use agent_message_type::AgentMessage;
pub use agent_typing_type::AgentTyping;
pub use agent_channels_table::*;
pub use agent_messages_table::*;
pub use agent_typing_table::*;
pub use clear_typing_reducer::clear_typing;
pub use create_channel_reducer::create_channel;
pub use mark_read_reducer::mark_read;
pub use send_dm_reducer::send_dm;
pub use send_to_channel_reducer::send_to_channel;
pub use set_typing_reducer::set_typing;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
                        Reducer::ClearTyping { .. } => "clear_typing",
            Reducer::CreateChannel { .. } => "create_channel",
            Reducer::MarkRead { .. } => "mark_read",
            Reducer::SendDm { .. } => "send_dm",
            Reducer::SendToChannel { .. } => "send_to_channel",
            Reducer::SetTyping { .. } => "set_typing",
            _ => unreachable!(),
}
}
...
fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
                        Reducer::ClearTyping{
                agent,
}             => __sats::bsatn::to_vec(&clear_typing_reducer::ClearTypingArgs {
                agent: agent.clone(),
}),
            ...
            Reducer::SendDm{
                ...
                message,
                thread_id,
}             => __sats::bsatn::to_vec(&send_dm_reducer::SendDmArgs {
                from: from.clone(),
                to: to.clone(),
                message: message.clone(),
                thread_id: thread_id.clone(),
}),
            Reducer::SendToChannel{
                from,
                channel,
                message,
                thread_id,
}             => __sats::bsatn::to_vec(&send_to_channel_reducer::SendToChannelArgs {
                from: from.clone(),
            ...
            Reducer::SetTyping{
                agent,
                channel_or_dm,
}             => __sats::bsatn::to_vec(&set_typing_reducer::SetTypingArgs {
                agent: agent.clone(),
                channel_or_dm: channel_or_dm.clone(),
}),
            _ => unreachable!(),
}
}
...
#[doc(hidden)]
pub struct DbUpdate {
        agent_channels: __sdk::TableUpdate<AgentChannel>,
    agent_messages: __sdk::TableUpdate<AgentMessage>,
    agent_typing: __sdk::TableUpdate<AgentTyping>,
}
...
impl TryFrom<__ws::v2::TransactionUpdate> for DbUpdate {
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        "agent_channels" => db_update.agent_channels.append(agent_channels_table::parse_table_update(table_update)?),
    "agent_messages" => db_update.agent_messages.append(agent_messages_table::parse_table_update(table_update)?),
    "agent_typing" => db_update.agent_typing.append(agent_typing_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(&self, cache: &mut __sdk::ClientCache<RemoteModule>) -> AppliedDiff<'_> {
                ...
                diff.agent_channels = cache.apply_diff_to_table::<AgentChannel>("agent_channels", &self.agent_channels);
        diff.agent_messages = cache.apply_diff_to_table::<AgentMessage>("agent_messages", &self.agent_messages).with_updates_by_pk(|row| &row.id);
        diff.agent_typing = cache.apply_diff_to_table::<AgentTyping>("agent_typing", &self.agent_typing);
...
for table_rows in raw.tables {
            match &table_rows.table[..] {
                                "agent_channels" => db_update.agent_channels.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "agent_messages" => db_update.agent_messages.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "agent_typing" => db_update.agent_typing.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
...
for table_rows in raw.tables {
            match &table_rows.table[..] {
                                "agent_channels" => db_update.agent_channels.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "agent_messages" => db_update.agent_messages.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "agent_typing" => db_update.agent_typing.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                unknown => { return Err(__sdk::InternalError::unknown_name("table", unknown, "QueryRows").into()); }
}}        Ok(db_update)
}
}
...
pub struct AppliedDiff<'r> {
        agent_channels: __sdk::TableAppliedDiff<'r, AgentChannel>,
    agent_messages: __sdk::TableAppliedDiff<'r, AgentMessage>,
    agent_typing: __sdk::TableAppliedDiff<'r, AgentTyping>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(&self, event: &EventContext, callbacks: &mut __sdk::DbCallbacks<RemoteModule>) {
                callbacks.invoke_table_row_callbacks::<AgentChannel>("agent_channels", &self.agent_channels, event);
        callbacks.invoke_table_row_callbacks::<AgentMessage>("agent_messages", &self.agent_messages, event);
        callbacks.invoke_table_row_callbacks::<AgentTyping>("agent_typing", &self.agent_typing, event);
}
}
...
fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
                agent_channels_table::register_table(client_cache);
        agent_messages_table::register_table(client_cache);
        agent_typing_table::register_table(client_cache);
}
