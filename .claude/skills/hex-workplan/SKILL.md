...
8. **Consumer dependency map**: For any step that deletes files/modules, verify that all consumers across ALL workspace crates have been identified and have corresponding fix steps
