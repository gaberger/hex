...
[Single Message - Swarm Initialization]:
  ...
  mcp__hex__hex_hexflo_swarm_status { type: "coordinator", name: "Release Director" }
  mcp__hex__hex_hexflo_swarm_status { type: "coder", name: "Version Manager" }
  mcp__hex__hex_hexflo_swarm_status { type: "tester", name: "QA Engineer" }
  mcp__hex__hex_hexflo_swarm_status { type: "reviewer", name: "Release Reviewer" }
  mcp__hex__hex_hexflo_swarm_status { type: "analyst", name: "Deployment Analyst" }
  mcp__hex__hex_hexflo_swarm_status { type: "researcher", name: "Compatibility Checker" }
```
...
[Single Message - Multi-Package Release]:
  ...
  mcp__hex__hex_hexflo_swarm_init { topology: "mesh", maxAgents: 8 }
...
[Single Message - Cross-Repo Release]:
  ...
  mcp__hex__hex_hexflo_swarm_init { topology: "star", maxAgents: 6 }
  ...
  mcp__hex__hex_hexflo_swarm_monitor { interval: 5, duration: 300 }
```
