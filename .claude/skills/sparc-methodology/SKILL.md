...
**Usage**:
```javascript
mcp__hex__hex_hexflo_sparc_mode {
  mode: "orchestrator",
...
mcp__hex__hex_hexflo_swarm_status { type: "architect" }
mcp__hex__hex_hexflo_swarm_status { type: "coder" }
mcp__hex__hex_hexflo_swarm_status { type: "tester" }
mcp__hex__hex_hexflo_swarm_status { type: "reviewer" }
```
...
[Single Message]:
  mcp__hex__hex_hexflo_swarm_status { type: "researcher" }
  mcp__hex__hex_hexflo_swarm_status { type: "coder" }
  mcp__hex__hex_hexflo_swarm_status { type: "tester" }
  TodoWrite { todos: [8-10 todos] }

// ❌ WRONG: Multiple messages
Message 1: mcp__hex__hex_hexflo_swarm_status { type: "researcher" }
Message 2: mcp__hex__hex_hexflo_swarm_status { type: "coder" }
...
mcp__hex__hex_hexflo_token_usage {
...
```javascript
// Initialize swarm
mcp__hex__hex_hexflo_swarm_init { topology: "hierarchical" }

// Execute mode
mcp__hex__hex_hexflo_sparc_mode { mode: "coder", task_description: "..." }

// Monitor progress
mcp__hex__hex_hexflo_swarm_monitor { interval: 5000 }

// Store in memory
mcp__hex__hex_hexflo_swarm_status { action: "store", key: "...", value: "..." }
```
