...
SpacetimeDB is hex's coordination backbone — 7 WASM modules (ADR-2026-04-05-0900) provide transactional state management for swarms, agents, inference, chat, and more. All clients (web dashboard, CLI, desktop) connect via WebSocket for real-time synchronization.
