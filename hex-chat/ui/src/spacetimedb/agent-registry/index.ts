...
import AgentHeartbeatRow from "./agent_heartbeat_table";
...
const tablesSchema = __schema({
  ...
  agent_heartbeat: __table({
    name: 'agent_heartbeat',
    indexes: [
      { accessor: 'agent_id', name: 'agent_heartbeat_agent_id_idx_btree', algorithm: 'btree', columns: [
        'agentId',
      ] },
    ],
    constraints: [
      { name: 'agent_heartbeat_agent_id_key', constraint: 'unique', columns: ['agentId'] },
    ],
  }, AgentHeartbeatRow),
});
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("update_status", UpdateStatusReducer),
);
