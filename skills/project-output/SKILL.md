---
name: project-output
description: Every project created by an agent must include README.md and a startup script. This skill defines the required output structure for any code generation task that creates a new project or application.
always_load: true
---
